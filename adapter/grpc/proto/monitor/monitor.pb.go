...
type FindTaskInfoByIdRsp struct {
	...
	AvgMemoryUsed    uint64  `protobuf:"varint,2,opt,name=AvgMemoryUsed,proto3" json:"AvgMemoryUsed,omitempty"`
	AvgMemoryMaxUsed uint64  `protobuf:"varint,3,opt,name=AvgMemoryMaxUsed,proto3" json:"AvgMemoryMaxUsed,omitempty"`
}
...
func (x *FindTaskInfoByIdRsp) GetAvgMemoryUsed() uint64 {
	if x != nil {
...
func (x *FindTaskInfoByIdRsp) GetAvgMemoryMaxUsed() uint64 {
	if x != nil {
...
var file_monitor_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x6f, 0x72, 0x79, 0x55, 0x73, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52,
	...
	0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x10, 0x41, 0x76, 0x67, 0x4d, 0x65, 0x6d,
