...
func (obj *Executor) FindTaskInfoById(ctx context.Context, taskId string) (*model.ResultByTaskId, error) {
	findResult, err := obj.MonitorManager.FindByTaskId(ctx, taskId)
	if err != nil {
